...
Main star of the show is the Jupyter notebook in this repository. It is intended to be used in an OpenShift AI environment with the Llama Stack configured.

To get started:

- Open the OpenShift AI web console
- Create a new project
- Navigate to your project and create a new workbench
- Leave everything as is and only provide a name and select the image: `Jupyter | PyTorch | CUDA | Python 3.12`
- Wait for the workbench to get in ready state and click on it's name (should be a link by then)
- Now you are in your Jupyter environment
- In the top menu bar, click on `Git` and `Clone a Repository` to clone this repository
- Now open the notebook (`.ipynb` file) and follow the instructions there - enjoy!
